...
void speed_output(void)
{
   ...
   {
     FTM_PwmDuty(FTM0,FTM_CH0,0);   //电机正转   CH0
     FTM_PwmDuty(FTM0,FTM_CH1,Controlvar.Pwm1_Out);  //CH1
   }
   if(Controlvar.Pwm1_Out<0)   // 反转条件
   {
      FTM_PwmDuty(FTM0,FTM_CH1,0);   //电机反转  CH0
      FTM_PwmDuty(FTM0,FTM_CH0,-Controlvar.Pwm1_Out);  //CH1
   }
   
   if(Controlvar.Pwm2_Out>=0)
   {
     FTM_PwmDuty(FTM0,FTM_CH2,0);   //电机正转   CH0
     FTM_PwmDuty(FTM0,FTM_CH3,Controlvar.Pwm2_Out);  //CH1
   }
   if(Controlvar.Pwm2_Out<0)   // 反转条件
   {
      FTM_PwmDuty(FTM0,FTM_CH3,0);   //电机反转  CH0
